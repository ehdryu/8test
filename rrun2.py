...
def main():
    ...
    * **파일 크기 제한**: 외부 AI API를 이용하므로, 일정 용량 이상의 파일은 인식이 어려울 수 있거나, 비교 속도가 느릴 수 있습니다.
    * **PDF 형식**: 스캔된 PDF 파일은 텍스트 추출이 제대로 되지 않을 수 있습니다. kipris 또는 google patent 등에서 다운 받은 파일을 이용하세요. (마우스로 drag가 가능해야 함)
